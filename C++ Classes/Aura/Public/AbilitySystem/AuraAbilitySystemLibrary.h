...
public:
	...
	// Third parameter is a pointer passed in by reference.
	...
	UFUNCTION(BlueprintCallable, Category="AuraAbilitySystemLibrary|CharacterClassDefaults")
	static UTagsTextsData* GetTagsTexts(const UObject* WorldContextObject);
	...
	UFUNCTION(BlueprintPure, Category="AuraAbilitySystemLibrary|GameplayEffects")
	static FGameplayTag GetSkillTag(const FGameplayEffectContextHandle& EffectContextHandle);
	
	/*
	 * Effect Context Setters
	 */
	
	// UPARAM(ref) to indicate that it is an input parameter and a non-const reference. Otherwise Unreal will considere it as un Ouput parameter in the blueprint.
	...
	UFUNCTION(BlueprintCallable, Category="AuraAbilitySystemLibrary|GameplayEffects")
	static void SetSkillTag(UPARAM(ref) FGameplayEffectContextHandle& EffectContextHandle, const FGameplayTag& InSkillTag);
	/*
	 * Gameplay Mechanics Utilities
	 */
	...
	UFUNCTION(BlueprintCallable, Category="AuraAbilitySystemLibrary|DamageEffect")
	static FGameplayEffectContextHandle ApplySkillDamageEffect(const FDamageEffectParams& Params);
